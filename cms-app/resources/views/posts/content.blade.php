   			...
   			<article class="format-standard">  
   				...
   				<div class="content-media">
						<div class="post-thumb" >
							<img src="{{asset('storage/'.$post->image)}}" style="max-width:100%;max-height:500px"> 
						</div>  
					</div>
					...
					<div class="primary-content">
						...
						<ul class="entry-meta">
							...
							<li class="cat"><a href="">{{$post->category->name}}</a>		
						</ul>						
						...
						<p class="tags">
		  			   ...
		  			   <div class="author-profile">
		  			   	<img src="{{asset('storage/' . $post->user->profile->image)}}" alt="">
		  			   	...
		  			   	<div class="about">
		  			   		...
		  			   		<ul class="author-social">
		  			   			<li><a href="{{$post->user->profile->facebook}}">Facebook</a></li>
						        <li><a href="{{$post->user->profile->twitter}}">Twitter</a></li>
		  			   		</ul>
		  			   	</div>
		...
		<div class="comments-wrap">
			<div id="comments" class="row">
               ...
               <div class="respond">
                  ...
                  <form name="contactForm" id="contactForm" method="post" action="{{ route('comments',$post->id) }}">
  					   <fieldset>
